function darkmode(){document.querySelector(".dark-mode-boton").addEventListener("click",cuerpoLLamado)}function cuerpoLLamado(){document.querySelector("body").classList.toggle("dark-mode")}function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponsive)}function navegacionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
